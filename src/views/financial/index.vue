<template>
  <div>
    <div class="lun_warp">
      <div class="lun_con">
        <img src="@/assets/img/互联网金融与管理/互联网金融与管理.png" alt="" />
      </div>
    </div>
    <page />
    <div class="show">
    ...
    <div class="show-text">
      <ul>
        <router-link to="/sichuan" tag="li">
          <div class="school-img">
            <img src="@/assets/img/互联网金融与管理/互联网金融与管理_03.jpg" alt="" />
          </div>
        ...
        <li>
          <div class="school-img">
            <img src="@/assets/img/互联网金融与管理/互联网金融与管理_05.jpg" alt="" />
          </div>
          <div class="school-text">
      ...
      <ul>
        <li>
          <div class="school-img">
            <img src="@/assets/img/互联网金融与管理/互联网金融与管理_09.jpg" alt="" />
          </div>
          <div class="school-text">
        ...
        <li>
          <div class="school-img">
            <img src="@/assets/img/互联网金融与管理/互联网金融与管理_10.jpg" alt="" />
          </div>
          <div class="school-text">
      ...
      <ul>
        <li>
          <div class="school-img">
            <img src="@/assets/img/互联网金融与管理/互联网金融与管理_13.jpg" alt="" />
          </div>
          <div class="school-text">
        ...
        <li>
          <div class="school-img">
            <img src="@/assets/img/互联网金融与管理/互联网金融与管理_14.jpg" alt="" />
          </div>
          <div class="school-text">
          ...
          <li>
            <div class="banner_li_left">
              <router-link to="/Service">
                <img
                  src="@/assets/img/互联网金融与管理/互联网金融与管理_01.jpg"
                  alt=""
                />
              </router-link>
              <div class="ul_text">
          ...
          <li>
            <div class="banner_li_left">
              <router-link to="/kongcheng">
                <img
                  src="@/assets/img/互联网金融与管理/互联网金融与管理_04.jpg"
                  alt=""
                />
              </router-link>
              <div class="ul_text">
            ...
            <div class="banner_li_right">
              <router-link to="/kongcheng">
                <img
                  src="@/assets/img/互联网金融与管理/互联网金融与管理_10.png"
                  alt=""
                />
              </router-link>
              <div class="ul_text_two">
          ...
          <li>
            <div class="banner_li_left">
              <router-link to="/gaotie">
                <img
                  src="@/assets/img/互联网金融与管理/互联网金融与管理_16.jpg"
                  alt=""
                />
              </router-link>
              <div class="ul_text">
            ...
            <div class="banner_li_right">
              <router-link to="/kongcheng">
                <img
                  src="@/assets/img/互联网金融与管理/互联网金融与管理_15.jpg"
                  alt=""
                />
              </router-link>
              <div class="ul_text_two">
  ...
  components: {
   ...
   data() {
    return {
      ...
      xia: "0",
      img: [
        { picture: require("@/assets/img/互联网金融与管理/互联网金融与管理1.jpg"), type: "0" },
        { picture: require("@/assets/img/互联网金融与管理/互联网金融与管理2.jpg"), type: "1" },
        { picture: require("@/assets/img/互联网金融与管理/互联网金融与管理3.jpg"), type: "2" },
        { picture: require("@/assets/img/互联网金融与管理/互联网金融与管理4.jpg"), type: "3" },
        { picture: require("@/assets/img/互联网金融与管理/互联网金融与管理5.jpg"), type: "4" },
      ],
      img2: [
        {
          pic: require("@/assets/img/互联网金融与管理/互联网金融与管理_(1).jpg"),
          type: "0",
        },
        {
          pic: require("@/assets/img/互联网金融与管理/互联网金融与管理_(2).jpg"),
          type: "1",
        },
        {
        ...
        {
          pic: require("@/assets/img/互联网金融与管理/互联网金融与管理_(4).jpg"),
          type: "3",
        },
        {
