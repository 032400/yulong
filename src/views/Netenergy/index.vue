<template>
  <div>
    <div class="lun_warp">
      <div class="lun_con">
        <img src="@/assets/img/新能源/新能源汽车.png" alt="" />
      </div>
    </div>
    <page />
    <div class="show">
      <div class="show-header">
        <img src="@/assets/img/新能源/网络新媒体运营_03.jpg" alt="" />
      </div>
      ...
      <div class="show-text">
        <ul>
          <router-link to="/sichuan" tag="li">
            <div class="school-img">
              <img src="@/assets/img/新能源/新能源汽车_03.jpg" alt="" />
            </div>
          ...
          <li>
            <div class="school-img">
              <img src="@/assets/img/新能源/新能源汽车_05.jpg" alt="" />
            </div>
            <div class="school-text">
        ...
        <ul>
          <li>
            <div class="school-img">
              <img src="@/assets/img/新能源/新能源汽车_09.jpg" alt="" />
            </div>
            <div class="school-text">
          ...
          <li>
            <div class="school-img">
              <img src="@/assets/img/新能源/新能源汽车_10.jpg" alt="" />
            </div>
            <div class="school-text">
        ...
        <ul>
          <li>
            <div class="school-img">
              <img src="@/assets/img/新能源/新能源汽车_13.jpg" alt="" />
            </div>
            <div class="school-text">
          ...
          <li>
            <div class="school-img">
              <img src="@/assets/img/新能源/新能源汽车_14.jpg" alt="" />
            </div>
            <div class="school-text">
            ...
            <li>
              <div class="banner_li_left">
                <router-link to="/Service">
                  <img src="@/assets/img/新能源/新能源汽车_35.jpg" alt="" />
                </router-link>
                <div class="ul_text">
            ...
            <li>
              <div class="banner_li_left">
                <router-link to="/kongcheng">
                  <img src="@/assets/img/新能源/新能源汽车_40.jpg" alt="" />
                </router-link>
                <div class="ul_text">
              ...
              <div class="banner_li_right">
                <router-link to="/kongcheng">
                  <img src="@/assets/img/新能源/新能源汽车_41.jpg" alt="" />
                </router-link>
                <div class="ul_text_two">
...
export default {
  ...
  data() {
    return {
      ...
      xia: "0",
      img: [
        { picture: require("@/assets/img/新能源/未标题-1_03.jpg"), type: "0" },
        { picture: require("@/assets/img/新能源/未标题-1_01.jpg"), type: "1" },
        { picture: require("@/assets/img/新能源/未标题-1_06.jpg"), type: "2" },
        {
          picture: require("@/assets/img/新能源/未标题-1_01_03.jpg"),
          type: "3",
        },
        { picture: require("@/assets/img/新能源/未标题-1_05.jpg"), type: "4" },
      ],
      img2: [
        {
          pic: require("@/assets/img/新能源/2.jpg"),
          type: "0",
        },
        {
          pic: require("@/assets/img/新能源/1.jpg"),
          type: "1",
        },
        {
          pic: require("@/assets/img/新能源/6.jpg"), ////111
          type: "2",
        },
        {
          pic: require("@/assets/img/新能源/3.jpg"),
          type: "3",
        },
        {
          pic: require("@/assets/img/新能源/4.jpg"),
          type: "4",
        },
      ],
