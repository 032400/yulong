<template>
  <div>
    <div class="lun_warp">
      <div class="lun_con">
        <img src="@/assets/img/人工智能与机器人/人工智能与机器.png" alt="" />
      </div>
    </div>
    <page />
    <div class="show">
    <div class="show-header">
      <img src="@/assets/img/公共/网络新媒体运营_03.jpg" alt="" />
    </div>
    ...
    <div class="show-text">
      <ul>
        <router-link to="/sichuan" tag="li">
          <div class="school-img">
            <img src="@/assets/img/人工智能与机器人/人工智能与机器人_03.jpg" alt="" />
          </div>
        ...
        <li>
          <div class="school-img">
            <img src="@/assets/img/人工智能与机器人/人工智能与机器人_05.jpg" alt="" />
          </div>
          <div class="school-text">
      ...
      <ul>
        <li>
          <div class="school-img">
            <img src="@/assets/img/人工智能与机器人/人工智能与机器人_09.jpg" alt="" />
          </div>
          <div class="school-text">
        ...
        <li>
          <div class="school-img">
            <img src="@/assets/img/人工智能与机器人/人工智能与机器人_10.jpg" alt="" />
          </div>
          <div class="school-text">
      ...
      <ul>
        <li>
          <div class="school-img">
            <img src="@/assets/img/人工智能与机器人/人工智能与机器人_13.jpg" alt="" />
          </div>
          <div class="school-text">
        ...
        <li>
          <div class="school-img">
            <img src="@/assets/img/人工智能与机器人/人工智能与机器人_14.jpg" alt="" />
          </div>
          <div class="school-text">
          ...
          <li>
            <div class="banner_li_left">
              <router-link to="/Service">
                <img
                  src="@/assets/img/人工智能与机器人/人工智能与机器人_36.jpg"
                  alt=""
                />
              </router-link>
              <div class="ul_text">
          ...
          <li>
            <div class="banner_li_left">
              <router-link to="/kongcheng">
                <img
                  src="@/assets/img/人工智能与机器人/人工智能与机器人_41.jpg"
                  alt=""
                />
              </router-link>
              <div class="ul_text">
            ...
            <div class="banner_li_right">
              <router-link to="/kongcheng">
                <img
                  src="@/assets/img/人工智能与机器人/人工智能与机器人_42.jpg"
                  alt=""
                />
              </router-link>
              <div class="ul_text_two">
          ...
          <li>
            <div class="banner_li_left">
              <router-link to="/gaotie">
                <img
                  src="@/assets/img/人工智能与机器人/人工智能与机器人_45.jpg"
                  alt=""
                />
              </router-link>
              <div class="ul_text">
            ...
            <div class="banner_li_right">
              <router-link to="/kongcheng">
                <img
                  src="@/assets/img/人工智能与机器人/人工智能与机器人_46.jpg"
                  alt=""
                />
              </router-link>
              <div class="ul_text_two">
  ...
  components: {
   ...
   data() {
    return {
      ...
      xia: "0",
      img: [
        { picture: require("@/assets/img/人工智能与机器人/人工智能与机器人_18（1）.jpg"), type: "0" },
        { picture: require("@/assets/img/人工智能与机器人/人工智能与机器人_18（2）.jpg"), type: "1" },
        { picture: require("@/assets/img/人工智能与机器人/人工智能与机器人_18（3）.jpg"), type: "2" },
        { picture: require("@/assets/img/人工智能与机器人/人工智能与机器人_18（4）.jpg"), type: "3" },
        { picture: require("@/assets/img/人工智能与机器人/人工智能与机器人_18(5).jpg"), type: "4" },
      ],
      img2: [
        {
          pic: require("@/assets/img/人工智能与机器人/人工智能与机器人_21.jpg"),
          type: "0",
        },
        {
          pic: require("@/assets/img/人工智能与机器人/人工智能与机器人_23.jpg"),
          type: "1",
        },
        {
        ...
        {
          pic: require("@/assets/img/人工智能与机器人/人工智能与机器人_27.jpg"),
          type: "3",
        },
        {
